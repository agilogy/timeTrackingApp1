...
class TimeTrackingAppTest : FunSpec() {
    init {
        ...
        test("Get hours per developer when range is inside the developer hours"){
            ...
            val expected = mapOf(DeveloperProject(developer, project) to Hours(0)) //maybe it should be 0.5 ...
            assertEquals(expected, result)
        }
        ...
        test("Get hours per developer when only one part of the range is inside") {
            ...
            assertEquals(expected, resultStartInsideEndOutside) //maybe this should be 0.5...
            assertEquals(expected, resultStartOutsideEndInside) //maybe this should be 0.5...
        }
    }
}